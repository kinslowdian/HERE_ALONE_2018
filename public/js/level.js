...
{
	displayList.layerSections = list$(".layer-sections");
	displayList.layerItems = list$(".layer-items");
...
function section_display()
{
	for(let i in levelKit.sectionsARR)
	{
		displayList["section" + levelKit.sectionsARR[i].num] = list$("." + levelKit.sectionsARR[i].classBuild);
